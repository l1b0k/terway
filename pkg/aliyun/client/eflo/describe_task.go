...
// DescribeTask invokes the eflo.DescribeTask API synchronously
...
// DescribeTaskWithChan invokes the eflo.DescribeTask API asynchronously
...
// DescribeTaskWithCallback invokes the eflo.DescribeTask API asynchronously
...
func CreateDescribeTaskRequest() (request *DescribeTaskRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "DescribeTask", "eflo", "openAPI")
