...
// ChangeResourceGroup invokes the eflo.ChangeResourceGroup API synchronously
...
// ChangeResourceGroupWithChan invokes the eflo.ChangeResourceGroup API asynchronously
...
// ChangeResourceGroupWithCallback invokes the eflo.ChangeResourceGroup API asynchronously
...
func CreateChangeResourceGroupRequest() (request *ChangeResourceGroupRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "ChangeResourceGroup", "eflo", "openAPI")
