...
// CreateCluster invokes the eflo.CreateCluster API synchronously
...
// CreateClusterWithChan invokes the eflo.CreateCluster API asynchronously
...
// CreateClusterWithCallback invokes the eflo.CreateCluster API asynchronously
...
type CreateClusterNetworks struct {
	...
	IpAllocationPolicy *[]CreateClusterNetworksIpAllocationPolicyItem `name:"IpAllocationPolicy" type:"Repeated"`
	VpdInfo            CreateClusterNetworksVpdInfo                   `name:"VpdInfo" type:"Struct"`
}
...
// CreateClusterNetworksIpAllocationPolicyItem is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksIpAllocationPolicyItem struct {
	BondPolicy        CreateClusterNetworksIpAllocationPolicyItemBondPolicy               `name:"BondPolicy" type:"Struct"`
	MachineTypePolicy *[]CreateClusterNetworksIpAllocationPolicyItemMachineTypePolicyItem `name:"MachineTypePolicy" type:"Repeated"`
	NodePolicy        *[]CreateClusterNetworksIpAllocationPolicyItemNodePolicyItem        `name:"NodePolicy" type:"Repeated"`
}

// CreateClusterNetworksVpdInfo is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksVpdInfo struct {
	VpdSubnets *[]string `name:"VpdSubnets" type:"Repeated"`
...
// CreateClusterNetworksIpAllocationPolicyItemBondPolicy is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksIpAllocationPolicyItemBondPolicy struct {
	BondDefaultSubnet string                                                            `name:"BondDefaultSubnet"`
	Bonds             *[]CreateClusterNetworksIpAllocationPolicyItemBondPolicyBondsItem `name:"Bonds" type:"Repeated"`
}

// CreateClusterNetworksIpAllocationPolicyItemMachineTypePolicyItem is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksIpAllocationPolicyItemMachineTypePolicyItem struct {
	Bonds       *[]CreateClusterNetworksIpAllocationPolicyItemMachineTypePolicyItemBondsItem `name:"Bonds" type:"Repeated"`
	MachineType string                                                                       `name:"MachineType"`
}

// CreateClusterNetworksIpAllocationPolicyItemNodePolicyItem is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksIpAllocationPolicyItemNodePolicyItem struct {
	Bonds  *[]CreateClusterNetworksIpAllocationPolicyItemNodePolicyItemBondsItem `name:"Bonds" type:"Repeated"`
	NodeId string                                                                `name:"NodeId"`
}

// CreateClusterNetworksIpAllocationPolicyItemBondPolicyBondsItem is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksIpAllocationPolicyItemBondPolicyBondsItem struct {
	Subnet string `name:"Subnet"`
	Name   string `name:"Name"`
}

// CreateClusterNetworksIpAllocationPolicyItemMachineTypePolicyItemBondsItem is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksIpAllocationPolicyItemMachineTypePolicyItemBondsItem struct {
	Subnet string `name:"Subnet"`
	Name   string `name:"Name"`
}

// CreateClusterNetworksIpAllocationPolicyItemNodePolicyItemBondsItem is a repeated param struct in CreateClusterRequest
type CreateClusterNetworksIpAllocationPolicyItemNodePolicyItemBondsItem struct {
	Subnet string `name:"Subnet"`
	Name   string `name:"Name"`
}
...
func CreateCreateClusterRequest() (request *CreateClusterRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "CreateCluster", "eflo", "openAPI")
