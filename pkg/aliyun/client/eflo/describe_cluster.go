...
// DescribeCluster invokes the eflo.DescribeCluster API synchronously
...
// DescribeClusterWithChan invokes the eflo.DescribeCluster API asynchronously
...
// DescribeClusterWithCallback invokes the eflo.DescribeCluster API asynchronously
...
func CreateDescribeClusterRequest() (request *DescribeClusterRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "DescribeCluster", "eflo", "openAPI")
