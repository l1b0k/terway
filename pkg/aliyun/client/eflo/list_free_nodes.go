...
// ListFreeNodes invokes the eflo.ListFreeNodes API synchronously
...
// ListFreeNodesWithChan invokes the eflo.ListFreeNodes API asynchronously
...
// ListFreeNodesWithCallback invokes the eflo.ListFreeNodes API asynchronously
...
func CreateListFreeNodesRequest() (request *ListFreeNodesRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "ListFreeNodes", "eflo", "openAPI")
