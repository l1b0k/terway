...
// DeleteCluster invokes the eflo.DeleteCluster API synchronously
...
// DeleteClusterWithChan invokes the eflo.DeleteCluster API asynchronously
...
// DeleteClusterWithCallback invokes the eflo.DeleteCluster API asynchronously
...
func CreateDeleteClusterRequest() (request *DeleteClusterRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "DeleteCluster", "eflo", "openAPI")
