...
// DescribeNode invokes the eflo.DescribeNode API synchronously
...
// DescribeNodeWithChan invokes the eflo.DescribeNode API asynchronously
...
// DescribeNodeWithCallback invokes the eflo.DescribeNode API asynchronously
...
func CreateDescribeNodeRequest() (request *DescribeNodeRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "DescribeNode", "eflo", "openAPI")
