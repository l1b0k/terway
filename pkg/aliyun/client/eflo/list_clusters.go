...
// ListClusters invokes the eflo.ListClusters API synchronously
...
// ListClustersWithChan invokes the eflo.ListClusters API asynchronously
...
// ListClustersWithCallback invokes the eflo.ListClusters API asynchronously
...
func CreateListClustersRequest() (request *ListClustersRequest) {
	...
	request.InitWithApiInfo("eflo", "2022-05-30", "ListClusters", "eflo", "openAPI")
