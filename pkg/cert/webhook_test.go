...
// getErrorClient wraps client.Client and returns an error for Get when getError returns non-nil.
type getErrorClient struct {
	client.Client
	getError func(key types.NamespacedName) error
}

func (e *getErrorClient) Get(ctx context.Context, key client.ObjectKey, obj client.Object, opts ...client.GetOption) error {
	if e.getError != nil {
		if err := e.getError(types.NamespacedName(key)); err != nil {
			return err
		}
	}
